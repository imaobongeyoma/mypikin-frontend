    ...
    <Wrapper>
      ...
      <form action="" className="form" onSubmit={upload}>
        ...
        <div className="form__image form__inputwrap">
          <label htmlFor="profile" className="form__label">Profile Image</label>
          <input
        ...
        <p className="form__terms">Signing up means you have read and agree to the Terms of Service and our Privacy Policy</p>
        ...
        <div className="form__existing">
          ...
          <p className="form__accowner">Already have an account? <span onClick={() => navigate("/login")} className="form__login">Log in</span></p>
        </div>
      </form>
      </div>
      </Wrapper>
